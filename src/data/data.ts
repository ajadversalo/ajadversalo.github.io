...
export const productList = [
    ...
    {
        title: 'ReviewGx', 
        description: 'ReviewGx is a Medication Therapy Management tool that looks at evidence-based pharmacogenomics, deprescribing insights and clinical lab data to help you perform comprehensive medication reviews.',
        image: 'reviewgx.jpg'
    },
    {
        title: 'Alogogen', 
        description: 'Algogen is an internal application used by the algorithm developers to create complex pharmacogenetic algorithms.',
        image: 'algogen.jpg'
    },
    {
        title: 'TrackGx', 
        description: 'TrackGx is mobile first application which allows patients to effortlessly monitor the efficacy of their prescriptions.',
        image: 'trackgx.jpg'
    },
    {
        title: 'LabGx', 
        description: 'LabGx enables uploading genetic data from laboratory results.',
        image: 'labgx.jpg'
    },         
    {
        title: 'Patient Dashboard', 
        description: 'The Patient Dashboard is the petient portal where they can see their lab reports and medication reviews.',
